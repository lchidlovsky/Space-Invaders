...
public class Executable extends Application {
    ...
    @Override
        public void start(Stage primaryStage) {
            ...
            Image backgroundPicture = new Image("file:./img/background_picture.png");
            BackgroundImage fond = new BackgroundImage(backgroundPicture, null, null, null, null);
            root.setBackground(new Background(fond));
